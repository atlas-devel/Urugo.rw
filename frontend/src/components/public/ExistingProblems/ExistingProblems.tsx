...
function ExistingProblems() {
  return (
    <div className="bg-gray-50 w-full p-4 md:p-8 md:py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:px-24 ">
        <div className=" bg-white  p-6 rounded-xl shadow-sm">
          <span className="rounded-lg mb-2 text-red-500 bg-red-100 w-fit block p-2 ">
            <Building size={30} />
          </span>
        ...
        <div className="bg-white  p-8 rounded-xl shadow-sm">
          <span className="rounded-lg mb-2 text-green-500 bg-green-100 w-fit block p-2 ">
            <Users size={30} />
          </span>
        ...
        <div className="bg-white  p-8 rounded-xl shadow-sm">
          <span className="rounded-lg mb-2 text-blue-500 bg-blue-100 w-fit block p-2 ">
            <Search size={30} />
          </span>
